...
appointmentRouter.post("/", authorize("appointments:write"), createAppointmentValidator, validate, appointmentController.createAppointmentController);
appointmentRouter.patch("/:id", authorize("appointments:write"), updateAppointmentValidator, validate, appointmentController.updateAppointmentController);
