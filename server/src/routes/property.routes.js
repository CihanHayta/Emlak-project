...
import { createPropertyValidator, updatePropertyValidator } from "../validators/property.validator.js";
...
propertyRouter.post("/", authorize("properties:write"), createPropertyValidator, validate, propertyController.createPropertyController);
propertyRouter.get("/:id", authorize("properties:read"), propertyController.getPropertyController);
propertyRouter.patch("/:id", authorize("properties:write"), updatePropertyValidator, validate, propertyController.updatePropertyController);
