...
import { createSessionController, createMockTokenController, getMeController, logoutController } from "../controllers/auth.controller.js";

export const authRouter = Router();

// mock-token: SADECE FIREBASE_MODE=mock iken çalışır (controller içinde
// kontrol edilir) — gerçek şifre denemesi olduğu için /session ile AYNI
// rate limit'i paylaşır.
authRouter.post("/mock-token", authRateLimit, createMockTokenController);
