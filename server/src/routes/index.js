...
import { vehicleMediaRouter } from "./vehicleMedia.routes.js";
import { propertyMediaRouter } from "./propertyMedia.routes.js";
...
apiRouter.use("/properties", propertyMediaRouter); // Aşama 6 — /:propertyId/media*, propertyRouter'ın `/`,`/:id`'siyle çakışmaz
apiRouter.use("/public/properties", publicPropertyRouter);
apiRouter.use("/vehicles", vehicleRouter);
apiRouter.use("/vehicles", vehicleMediaRouter); // Aşama 6 — /:vehicleId/media*, vehicleRouter'ın `/`,`/:id`'siyle çakışmaz
