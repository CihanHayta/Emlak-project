...
//
// AŞAMA 7 CUTOVER: vehicle.service.js (Firestore) yerine artık
// vehicle.postgres.service.js kullanılıyor — bu, bu projede Firestore'dan
// Postgres'e geçen İLK canlı route. Güvenli kabul edildi çünkü FIREBASE_MODE
// hâlâ "mock" (gerçek Firestore projesi bağlı değil, kaybedilecek gerçek
// veri yok). vehicle.service.js dosyasının KENDİSİ silinmedi — Aşama 6'nın
// başından beri kurulan metodolojiyle tutarlı, ileride gerekirse geri
// dönülebilir.
