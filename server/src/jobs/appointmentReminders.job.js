...
//
// Tenant başına ayrı bir randevu penceresi/otomasyon ayarı olduğu için tüm
// tenant'lar için TEK bir sorgu yok — getActiveTenants() ile enumerate edip
// her biri için ayrı ayrı appointmentRepository.findByDateRange çağrılır.
// AŞAMA 11 CUTOVER: appointments artık Postgres'te — bkz. automation.service.js'in aynı gerekçeli yorumu.
import { getActiveTenants } from "../services/tenant.service.js";
import { appointmentPostgresRepository as appointmentRepository } from "../repositories/appointment.postgres.repository.js";
