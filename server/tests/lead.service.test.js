...
describe("lead.service", () => {
  ...
  // AŞAMA 11: "newLeadWelcome otomasyonu AÇIK" senaryosu buradan kaldırıldı —
  ...
  // testinde çalışamıyor. Aynı senaryo tests/postgres/lead.postgres.service.test.js'e
  // taşındı. "KAPALIYKEN" senaryosu burada KALDI çünkü notifyNewLead
  // otomasyon kapalıyken hiçbir repository'ye hiç dokunmadan erken dönüyor —
  // bu dosyanın (lead.service.js, hâlâ Firestore) kendi mantığını gerçekten test ediyor.
