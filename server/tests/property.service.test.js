...
describe("property.service — İlan Eşleşmesi otomasyonu tetikleyicisi (2026-08-13)", () => {
  ...
  // AŞAMA 11: otomasyonun GERÇEKTEN tetiklendiği 3 senaryo buradan kaldırıldı
  // — automation.service.js artık customers/automationEvents için Postgres
  // repository'lerini kullanıyor (bkz. o dosyanın yorumu), bu Firestore-mock
  // testinde çalışamıyorlar. Aynı 3 senaryo tests/postgres/property.postgres.service.test.js'e
  // taşındı. Bu test KALDI çünkü notifyIfPublished "unpublished" durumunda
  // automation.service.js'e (Postgres) hiç dokunmadan erken dönüyor — bu
  // dosyanın (property.service.js, hâlâ Firestore) kendi mantığını gerçekten test ediyor.
